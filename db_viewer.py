...
function applyTheme(theme) {{
  const themes = ['light', 'midnight', 'nord', 'purple', 'emerald', 'rose', 'cyan', 'forest', 'coffee', 'ocean', 'mono', 'sunset'];
