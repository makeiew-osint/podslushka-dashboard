...
border-radius:24px;background:rgba(22,34,56,.88);box-shadow:28px 34px 0 #060b16aa,0 24px 80px #0008;backdrop-filter:blur(14px);transform:rotateX(2deg) rotateY(-2deg);transform-style:preserve-3d}}
.intro{{padding:48px 42px;background:linear-gradient(145deg,#1b3966,#14243d);position:relative;overflow:hidden;transform:translateZ(18px)}}
...
.logo{{width:44px;height:44px;display:grid;place-items:center;border-radius:13px;background:linear-gradient(135deg,#70a7ff,#3d6cf0);font-size:23px;box-shadow:7px 8px 0 #244a9a,0 12px 24px #2f6fff55;transform:translateZ(30px)}}
...
background:#0c1729;color:#fff;outline:none;font-size:15px;transition:.2s}}input:focus{{border-color:var(--blue);box-shadow:0 0 0 3px #4f8cff22,0 6px 0 #244a9a;transform:translateY(-2px)}}
...
color:white;font-weight:800;font-size:15px;cursor:pointer;box-shadow:0 6px 0 #244a9a,0 12px 20px #3975ed44;transition:.2s}}
.submit:hover{{transform:translateY(-2px);filter:brightness(1.08)}}.submit:active{{transform:translateY(3px);box-shadow:0 2px 0 #244a9a}}.hint{{margin:20px 0 0;text-align:center;color:#7085a3;font-size:12px}}
...
.layout{{display:flex;min-height:100vh;perspective:1500px}}.sidebar{{position:fixed;inset:0 auto 0 0;width:255px;padding:25px 16px;background:linear-gradient(180deg,#13213a,#0e1728);border-right:1px solid #243956;z-index:5;box-shadow:10px 0 24px #02071188}}
.brand{{display:flex;align-items:center;gap:11px;padding:4px 10px 28px;font-size:19px;font-weight:800;letter-spacing:-.4px}}.logo{{display:grid;place-items:center;width:36px;height:36px;border-radius:11px;background:linear-gradient(135deg,#70a7ff,#3d6cf0);box-shadow:5px 6px 0 #244a9a,0 8px 22px #3975ed55;font-size:19px;transform:translateZ(16px)}}
.menu-title{{padding:0 11px 9px;color:#7085a3;text-transform:uppercase;font-size:10px;font-weight:800;letter-spacing:1px}}.nav{{display:grid;gap:5px}}.nav a{{display:flex;align-items:center;gap:11px;padding:12px 11px;border:1px solid transparent;border-radius:10px;color:#adc0d9;text-decoration:none;font-weight:600;transition:.18s}}.nav a:hover,.nav a.active{{color:#fff;background:#263e63;border-color:#3b6095;box-shadow:5px 6px 0 #0a1427,0 6px 18px #06112655;transform:translate(-2px,-2px)}}.nav a{{transition:.18s;transform-style:preserve-3d}}.nav .icon{{width:20px;text-align:center;font-size:16px}}
...
.cards{{display:grid;grid-template-columns:repeat(6,1fr);gap:13px;margin:0 0 27px}}.card{{background:linear-gradient(145deg,#1b2b45,#152238);border:1px solid #2b4568;border-radius:15px;padding:17px;box-shadow:7px 8px 0 #080f1e,0 12px 30px #03091435;transition:.2s;transform:translateZ(8px)}}.card:hover{{transform:translateY(-4px) rotateX(2deg);box-shadow:9px 12px 0 #080f1e,0 18px 34px #03091466}}.card b{{display:block;color:#94aaca;font-size:12px;font-weight:600}}.card strong{{display:block;font-size:28px;margin-top:9px;color:#f4f8ff}}
