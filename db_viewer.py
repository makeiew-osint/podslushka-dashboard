...
@media(min-width:701px){{.shell{{width:min(500px,100%)}}.auth-mark{{margin-bottom:22px}}.auth-mark img{{width:76px;height:76px;border-radius:18px}}.auth h2{{font-size:29px;font-weight:500;letter-spacing:-.4px}}.sub{{font-size:15px;margin-bottom:24px}}.tabs{{padding:6px 6px 0}}.tab{{padding:12px;font-size:14px}}.form.active{{padding:26px 28px}}.field{{margin-top:16px;font-size:14px}}.form input{{padding:12px 14px;font-size:15px}}.submit{{margin-top:6px;padding:12px;font-size:15px}}.oauth{{margin-top:28px;padding-top:22px;gap:12px}}.oauth-title{{font-size:13px}}.oauth-button,.telegram-button{{min-height:44px;font-size:14px}}.hint{{font-size:13px;line-height:1.5}}}}
