...
.osint-mode-card{{display:flex!important;align-items:center;justify-content:flex-start;gap:10px;flex:1 1 0;min-width:0;min-height:62px;padding:10px 13px!important}}
