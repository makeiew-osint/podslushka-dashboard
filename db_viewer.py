...
.dashboard-flow{{position:fixed;inset:0;width:100%;height:100%;border:0;opacity:.42;pointer-events:none;z-index:0;mix-blend-mode:screen;display:block;background:#050607}}
.ambient-scene{{display:none!important}}
.layout{{position:relative;z-index:1;background:linear-gradient(90deg,#0d1117d9 0%,#0d1117b8 48%,#0d111799 100%)}}
