...
body.light{{--bg:#eef4ff;--sidebar:#dce8ff;--panel:#ffffff;--panel2:#e8efff;--line:#b7c9e8;--text:#17233d;--muted:#5f7090;--blue:#5267d8;--blue2:#079b9b;--danger:#c53d62;--shadow:#b7c6df;--input:#f7faff}}
...
body.light .sidebar{{background:linear-gradient(180deg,#dce8ff,#c5d7f5);border-color:#abc1e4;box-shadow:10px 0 24px #7694c433}}
