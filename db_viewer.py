...
.intro:before{{content:"";position:absolute;width:180px;height:180px;border-radius:50%;right:35px;top:35px;background:radial-gradient(circle at 30% 25%,#fff8,#7b61ff66 18%,#21175c 65%);box-shadow:inset -20px -24px 25px #08061d99,0 20px 40px #0007;transform:translateZ(35px);opacity:.8}}
...
.layout{{display:flex;min-height:100vh;perspective:1500px}}.sidebar{{position:fixed;inset:0 auto 0 0;width:255px;padding:25px 16px;background:linear-gradient(180deg,#171943,#0d1028);border-right:1px solid #38366d;z-index:5;box-shadow:10px 0 24px #02071188,12px 0 45px #6e52ff18}}
