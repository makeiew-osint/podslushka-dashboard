...
.setup-grid{{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;margin:0 0 20px}}.bot-stage{{position:relative;display:grid;place-items:center;min-height:145px;margin:0 0 16px;border:1px solid #40558b;border-radius:18px;background:radial-gradient(circle at 50% 42%,#367dff2b,transparent 35%),linear-gradient(145deg,#172b55,#0d162f);box-shadow:8px 10px 0 #080d1d,0 0 35px #347cff22;overflow:hidden;perspective:700px}}.bot-stage:before,.bot-stage:after{{content:"";position:absolute;border:1px solid #61a0ff55;border-radius:50%;transform:rotateX(68deg);animation:ringSpin 8s linear infinite}}.bot-stage:before{{width:190px;height:72px}}.bot-stage:after{{width:250px;height:105px;animation-direction:reverse;animation-duration:11s}}.bot-model{{position:relative;width:58px;height:58px;transform-style:preserve-3d;animation:cubeFloat 5s ease-in-out infinite}}.bot-model i,.bot-model b{{position:absolute;inset:0;border:1px solid #9abaff99;background:linear-gradient(135deg,#5b83ff99,#20d8c933);box-shadow:0 0 25px #3988ff66;backface-visibility:hidden}}.bot-model i:nth-child(1){{transform:translateZ(29px)}}.bot-model i:nth-child(2){{transform:rotateY(180deg) translateZ(29px)}}.bot-model i:nth-child(3){{transform:rotateY(90deg) translateZ(29px)}}.bot-model i:nth-child(4){{transform:rotateY(-90deg) translateZ(29px)}}.bot-model i:nth-child(5){{transform:rotateX(90deg) translateZ(29px)}}.bot-model i:nth-child(6){{transform:rotateX(-90deg) translateZ(29px)}}.bot-stage-label{{position:absolute;bottom:12px;color:#a9c9ff;font-size:11px;letter-spacing:1.2px;text-transform:uppercase}}.setup-card{{position:relative;isolation:isolate;display:grid;gap:10px;padding:18px;border:1px solid #40558b;border-radius:16px;background:linear-gradient(145deg,#202d50,#131a34);box-shadow:7px 8px 0 #080d1d,0 16px 30px #03071388;animation:cardIn .55s both;overflow:hidden;transition:transform .3s,box-shadow .3s}}.setup-card:hover{{transform:translateY(-5px) rotateX(1deg);box-shadow:10px 13px 0 #080d1d,0 22px 42px #216dff33}}.setup-card:before{{content:"";position:absolute;z-index:-1;width:105px;height:105px;right:-33px;top:-40px;border:1px solid #70a7ff55;border-radius:25px;transform:rotate(35deg);box-shadow:inset 0 0 24px #3f8dff33,0 0 24px #3f8dff22;animation:modelFloat 6s ease-in-out infinite}}.setup-card:after{{content:"";position:absolute;z-index:-1;width:54px;height:54px;right:52px;bottom:-26px;border-radius:50%;background:radial-gradient(circle at 30% 25%,#b7f5ff,#2187d466 36%,transparent 70%);filter:blur(.2px);animation:orbFloat 4.5s ease-in-out infinite}}.setup-card:first-child button{{width:max-content;min-width:150px;justify-self:start;padding-inline:25px}}.setup-card h3{{margin:0;color:#dbe7ff}}.setup-card input,.setup-card select{{width:100%;min-width:0}}.setup-card label{{color:#aebddd;font-size:12px}}
