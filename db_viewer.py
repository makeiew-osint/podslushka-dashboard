...
.osint-search-form fieldset{{display:flex;align-items:center;gap:10px;min-height:58px;margin:0;border:1px solid #173b68;padding:10px 12px;border-radius:16px;background:#071426cc}}
...
.osint-tool-card{{display:flex!important;align-items:center;justify-content:space-between;flex:1;min-height:64px;padding:10px 14px!important;background:linear-gradient(145deg,#0d2340,#0a172c)!important}}
...
.osint-mode-card{{display:flex!important;align-items:center;justify-content:flex-start;gap:10px;min-height:62px;padding:10px 13px!important}}
