...
.brand{{display:flex;gap:12px;align-items:center;color:var(--ink);text-decoration:none;font-weight:800}}.brand img{{width:42px;height:42px;border-radius:12px;object-fit:cover;box-shadow:0 0 0 1px #ffca8266,0 8px 20px #0005}}
.links{{display:flex;gap:8px;flex-wrap:wrap}}.links a,.back{{padding:11px 17px;border:1px solid #6d4e73;border-radius:999px;color:#fff8ef;text-decoration:none;background:#24172e;box-shadow:0 5px 0 #110b17,0 10px 22px #0004;font-size:13px;font-weight:750;transition:transform .18s,background .18s,border-color .18s,box-shadow .18s}}.links a:hover,.links .active{{border-color:var(--accent);background:#754d67;color:#fff;transform:translateY(-2px);box-shadow:0 7px 0 #110b17,0 14px 26px #0005}}.links a:focus-visible{{outline:3px solid var(--accent);outline-offset:3px}}
...
.flow,.reason-grid,.wallets{{display:grid;gap:12px;margin-top:28px}}.flow{{grid-template-columns:repeat(7,auto);align-items:center;justify-content:start}}.flow span,.flow i{{padding:13px 15px;border:1px solid var(--line);background:#21162bdd;border-radius:10px;font-style:normal}}.flow i{{border:0;color:var(--accent);padding:0}}
.reason-grid{{grid-template-columns:repeat(3,1fr)}}.reason-grid article,.support-block,.faq details{{padding:22px;border:1px solid var(--line);border-radius:14px;background:#21162bdd;box-shadow:0 14px 35px #0003}}.reason-grid strong{{color:var(--accent);font-size:13px}}.reason-grid h2{{font-size:21px}}
...
.support-block{{margin-top:26px}}.wallets{{grid-template-columns:repeat(2,1fr)}}.wallets div{{padding:14px;border:1px solid var(--line);border-radius:10px;background:#160e1ddd}}.wallets b{{display:block;color:var(--accent);margin-bottom:8px;font-size:13px}}code{{display:block;overflow:auto;color:#ffe9d2;font:12px Consolas,monospace;white-space:nowrap}}
...
.public-nav{{left:50%!important;right:auto!important;transform:translateX(-50%)!important;top:22px!important;padding:7px!important;border:1px solid #604663!important;border-radius:999px!important;background:#1c1225d9!important;box-shadow:0 8px 26px #0006!important;backdrop-filter:blur(14px)!important;justify-content:center!important}}
.public-nav a{{padding:10px 16px!important;border:0!important;border-radius:999px!important;background:transparent!important;box-shadow:none!important;color:#eadfea!important;white-space:nowrap!important;transition:background .18s,transform .18s,color .18s!important}}
...
.public-nav #open-auth{{background:var(--accent)!important;color:#1b1020!important;box-shadow:0 4px 0 #7d4b4b!important;font-weight:850!important}}
.public-nav #open-auth:hover{{background:#ffd09a!important;transform:translateY(-2px)!important}}
@media(max-width:700px){{.public-nav{{top:12px!important;width:calc(100% - 24px)!important;max-width:420px!important;flex-wrap:wrap!important;gap:2px!important;padding:5px!important}}.public-nav a{{padding:9px 10px!important;font-size:11px!important}}.public-nav .nav-links{{gap:1px!important}}.intro{{padding:94px 24px 36px!important}}.intro h1{{font-size:54px!important}}.features{{grid-template-columns:1fr!important;gap:10px!important;margin-top:22px!important}}.feature{{border-top:0;padding-top:0!important}}.auth{{padding:25px 20px!important}}}}
...
<section class="intro"><div class="brand"><img class="brand-logo" src="/assets/podslushka-mark.svg" alt="Podslushka DB"><span>Podslushka DB</span></div>
...
<div class="auth-backdrop" id="auth-backdrop"></div><section class="auth" id="auth-panel"><button class="auth-close" type="button" id="auth-close">Закрыть</button><div class="auth-mark"><img src="/assets/podslushka-mark.svg" alt=""></div><h2 id="title">Добро пожаловать</h2><p class="sub" id="subtitle">Войдите, чтобы продолжить работу.</p>
